...
class MessageTVC: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        appDelegate.notification.addObserver(self, selector: #selector(MessageTVC.updateMessage), name: notificationName, object: nil)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = appDelegate.myMessages[indexPath.row]
